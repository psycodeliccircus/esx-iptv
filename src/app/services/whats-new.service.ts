...
export class WhatsNewService {
    ...
    modals = {
        ...
        '0.8.0': [
            ...
            {
                title: 'This and that',
                html: 'In addition to the already mentioned new features, some bugs have been fixed and the internal dependencies of the application have been updated. Thanks for all the <a href="https://github.com/psycodeliccircus/esx-iptv/issues" target="_blank">ideas</a>, contributions and <a target="_blank" href="https://www.buymeacoffee.com/4gray">first donations.</a>',
                button: {
                    text: 'YAY!',
                    textColor: '#ccc',
                    bgColor: '#111',
        ...
        '0.9.0': [
            {
                ...
                html: 'The new version of the app has an option to <a href="https://github.com/psycodeliccircus/esx-iptv/issues/77" target="_blank">sort the playlists</a> using drag&drop.',
                button: {
                    text: 'YAY!',
                    textColor: '#ccc',
                    bgColor: '#111',
            ...
            },
            {
                ...
                html: `
                    ...
                    * bugfixes and visual improvements, see <a href="https://github.com/psycodeliccircus/esx-iptv/blob/master/CHANGELOG.md">changelog</a> for more details
                `,
                button: {
                    text: 'YAY!',
                    textColor: '#ccc',
