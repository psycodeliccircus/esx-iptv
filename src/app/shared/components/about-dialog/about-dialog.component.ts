...
@Component({
    ...
    template: `
        <div mat-dialog-content>
            ...
            <p>
                <a
                    href="https://github.com/psycodeliccircus/esx-iptv"
                    target="_blank"
                ...
                >&nbsp;
                <a
                    href="http://twitter.com/share?text=ESX-IPTV &mdash; free cross-platform IPTV player. Available as PWA and as native application.&url=https://github.com/psycodeliccircus/esx-iptv&hashtags=iptv,m3u,video-player"
                ...
                <a
                    href="https://www.buymeacoffee.com/renildomarcio"
                    target="_blank"
